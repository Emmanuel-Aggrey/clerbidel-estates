"""
Django settings for clerbidel project.
...
SECRET_KEY = '3m+jg_%5u#eke$+(v(hd_f2_y4-btvjxt+sk6z0v^ih7fd2ovl'
...
WSGI_APPLICATION = 'clerbidel.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'clerbidel/static')
]
